...
using Seneca.Interception.Core.Tests.Interceptors.Stubs;
...
public class LoggingWithoutArgumentsInterceptorFixture
{
        ...
        GetEnvironment(bool isValid = true)
    {
        ...
        stub.Setup(s => s.GetModel(It.IsAny<string>()))
            .Returns(Task.FromResult(model));

        var invocation = new Mock<Castle.DynamicProxy.IInvocation>();
        invocation
            .SetupGet(i => i.InvocationTarget)
            .Returns(stub.Object);
        
        invocation
            .SetupGet(i => i.Method)
            .Returns(typeof(IStubWithGenericTask).GetMethod(nameof(IStubWithGenericTask.GetModel)))
            .Verifiable();
        ...
        GetEnvironment2(bool isValid = true)
    {
        ...
        invocation
            .SetupGet(i => i.Method)
            .Returns(typeof(IStubWithVoid).GetMethod(nameof(IStubWithVoid.Handle)))
            .Verifiable();
        ...
        GetEnvironment3(bool isValid = true)
    {
        ...
        invocation
            .SetupGet(i => i.Method)
            .Returns(typeof(IStubWithTask).GetMethod(nameof(IStubWithTask.Run)))
            .Verifiable();
